...
public class Hydra extends Animal implements Swimmable {
  ...
  public Hydra (String name, int numberoflegs, int age, String type, int levelofdanger,String sleep, int foodLevel,String hugescream, String aquaticblast,Double sellable, String category){
